      ...
      cartItemElement.innerHTML = `
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="font-medium mt-2">Qtd por pessoa: 0${item.quantity}</p>
          </div>
...
if(index !== -1)
  ...
  checkoutBtn.addEventListener("click", function(){
    ...
    window.open(`https://wa.me/${phone}?text=${menssage} Nome: ${nameInput.value} Matrícula: ${matrInput.value}`, "_blank");
